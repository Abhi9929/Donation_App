<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeBehind="buyerPage.aspx.cs" Inherits="Donation_App.buyerPage" %>
        ...
        <div class="wrapper">
            ...
            <asp:GridView ID="GridView1" runat="server" CssClass="myGrid" Width="60%" CellPadding="4"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Buyer Mail">
                        <ItemTemplate>
                            <%#Eval("Buyer_Mail") %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Message">
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton2" CssClass="linkBtn" runat="server" CommandName='<%#Eval("Buyer_Mail") %>'
                                OnCommand="ChatWithBuyer"
                                Text="Chat">
                            </asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
